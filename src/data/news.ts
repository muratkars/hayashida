...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Mr. Chen noted that the division's data footprint has grown approximately threefold over the past three years, driven by increased model granularity, expanded scenario coverage, and regulatory mandates from the JFSA, FCA, SEC, and MAS requiring more comprehensive risk data retention and auditability. The existing HDFS clusters were not designed for this scale of growth, leading to cluster sprawl and escalating TCO.",
